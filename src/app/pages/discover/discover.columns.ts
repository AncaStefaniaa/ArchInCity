export const architecturalStyles: any[] = [
  {
    ...
    image: "https://www.ancient.eu/img/r/p/500x600/10669.jpg.avif?v=1608709503",
  },
  {
    ...
    origins: ["Boston", "United States", "1890s"],
    characteristics: [
      "interior design",
      "landscape design",
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Craftsmanhouse.jpg/330px-Craftsmanhouse.jpg",
  },
  {
    ...
    origins: ["United States", "mid-1890s to the late 1930s"],
    characteristics: [
      "elements of the Victorian",
      "boxy design",
      "wide stairs",
    ],
    wikipedia: "https://en.wikipedia.org/wiki/American_Foursquare",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/831Richland.jpg/450px-831Richland.jpg",
  },
  {
  ...
  },
  {
    ...
    origins: ["France just before World War I"],
    characteristics: [
      "relative simplicity",
      "planarity",
  ...
  },
  {
    ...
    origins: ["about 1890 and 1910", "Europe", "United States"],
    characteristics: ["use of a long, sinuous, organic line"],
    wikipedia: "https://en.wikipedia.org/wiki/Art_Nouveau",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/BeursVanBerlage.jpg/600px-BeursVanBerlage.jpg",
  },
  {
    name: "Baroque",
    id: 6,
    ...
    origins: ["early 17th century", "spread across Europe"],
    characteristics: [
...

  {
    ...
    characteristics: ["Dutch Colonial", "French Colonial", "American colonial"],
    wikipedia:
  ...
  },
  {
    ...
    origins: ["1901–1910", "United Kingdom"],
    characteristics: ["lighter colours were used", "less complex patterns"],
    wikipedia: "https://en.wikipedia.org/wiki/Edwardian_architecture",
    image:
